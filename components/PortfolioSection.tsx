...
export const PortfolioSection: React.FC<PortfolioSectionProps> = ({ language, externalFilter }) => {
  ...
  // Tab State: 'gallery' or 'figma'
  const [viewMode, setViewMode] = useState<'gallery' | 'figma'>('gallery');
  ...
  useEffect(() => {
    if (selectedProject) {
      ...
      setViewMode('gallery'); // Reset to gallery view
             ...
             {displayProject && (
               <>
                 ...
                 {displayProject.category === Category.PHOTO ? (
                    ...
                    <>
                     {/* Tab Switcher - Only show if both gallery and figma exist */}
                     {currentGallery.length > 0 && displayProject.figmaUrl && (
                       <div className="w-full border-b-2 border-gray-200 dark:border-gray-800 flex gap-0">
                         <button
                           onClick={() => setViewMode('gallery')}
                           className={`flex-1 py-4 text-xl font-black uppercase tracking-wider transition-all ${
                             viewMode === 'gallery'
                               ? 'bg-black dark:bg-white text-white dark:text-black'
                               : 'bg-transparent text-gray-400 hover:text-black dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800'
                           }`}
                         >
                     ...
                     {currentGallery.length > 0 && viewMode === 'gallery' ? (
                     ...
                     // Figma/Video/Default Media View
                     <div className={`
